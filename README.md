...
**Project**: eco-navigate-landing 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: a landing page for ecomerce with navbar 
...
```sh
git clone https://github.com/GPT-Engineer-App/eco-navigate-landing.git
cd eco-navigate-landing
npm i
